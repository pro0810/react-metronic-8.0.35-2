...
export function PrivateRoutes() {
  ...
  const UrlsPageWrapper = lazy(() => import('../pages/url-management/UrlsPage'))
  ...
  return (
    <Suspense fallback={<FallbackView />}>
      <Switch>
        ...
        <Route path='/reports' component={ReportsPageWrapper} />
        <Route path='/urls' component={UrlsPageWrapper} />
